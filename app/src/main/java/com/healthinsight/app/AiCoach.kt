...
[부하·다음 운동] 생활런은 총 마일리지·부상 부하엔 포함하되 메인 훈련과 구분. 하체운동/스쿼트 후 러닝은 허벅지·종아리 피로 큼 → 다음 추천에 반영. 강한 기록주·템포 후 24~48시간 회복. 최근 주간거리 급증 시 안정화·부상방지 최우선(심폐는 빨리, 힘줄·정강이·발은 천천히 적응). 다음 운동은 오늘 부하+내일 컨디션+부상 신호+주간 구조를 고려해 거리·페이스·심박·코스·금지사항까지 구체적으로. "5km 6:30~6:40" 식 고정 추천 금지.
""".trim()
